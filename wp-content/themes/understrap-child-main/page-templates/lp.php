    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-11 col-lg-10">
          <h1 class="h2">Assessoria Jurídica Especializada em Inventários e Empresas.</h1>
          <a href="#vamosconversar" class="defaultButton" >Vamos Conversar?</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-lg-8 offset-lg-1 about_text">
          ...
          <p>
            Artur de Padua Yoshida de Oliveira ou como é conhecido “Dr. Artur Yoshida”. Nascido em São Bernardo do Campo, é advogado desde 14 de março de 2014, Em mais de 11 anos de experiência atuando nas áreas de Direito Civil, especialmente em inventários, usucapiões e empresas, com consultoria preventiva e estratégica em processos judiciais e extrajudiciais complexos, é Pós-graduado em Advocacia Cível pela Escola Brasileira de Direito (EBRADI) e pós-graduando em Direito Societário pela Pontifícia Universidade Católica do Rio Grande do Sul (PUCRS) reforçando a graduação em Direito celebrada na cidade de Santos/SP, pela Escola Superior de Administração, Marketing e Comunicação (ESAMC – Santos).
          </p>
          <h3>
            CARREIRA
          </h3>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center mb-3 mb-lg-5">
          <h2 class="h1">RELATOS DE CLIENTES</h2>
        </div>
        <div class="col-12">
            ...
            <div class="swiper-wrapper">
              <?php for ($i=0; $i < 5; $i++) : ?>
                <div class="swiper-slide item">
                  <p>
                    “Atendimento excelente, cordialidade, atencioso, respeitoso e profissional super competente! Recomendo!”
                  </p>
                  <div class="item_title">
                    <h3 class="h6">Maria da Silva</h3>
    ...
    <div class="container">
      <div class="row justify-content-center" id="vamosconversar">
        <div class="col-10 col-lg-4 contact_title">
          <h2 class="h1">Vamos Conversar?</h2>
        ...
        <div class="col-10 col-lg-5 offset-lg-1 contact_text">
          <h3 class="mb-3">
            Aberto a Conexões, Parcerias e Novos Desafios
          </h3>
          <p>
            Estou aberto a conectar com outros profissionais e empresas para troca de ideias e parcerias. Ficarei feliz em conversar sobre soluções jurídicas inovadoras e projetos, especialmente para demandas complexas que envolvam estratégia e diversos problemas a serem resolvidos. Quanto maior o problema, maior será o meu interesse. 
          </p>
